...
const CONFIG = {
  ...
  SECTION_PADDING_X: 40, // px, matches the other sections' edge padding
  ...
  FONT: "clamp(2rem, 5vw, 4.75rem)", // min / preferred(vw) / max — big, fills the section
  MAX_WIDTH: "64%", // keeps the block tall + narrow like the reference
...
export default function BridgeText() {
  ...
  return (
    <section ref={sectionRef} style={{ height: `${CONFIG.SCROLL_VH}vh` }} className="relative">
      <div
